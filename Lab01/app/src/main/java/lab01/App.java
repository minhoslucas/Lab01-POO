 ...
 */
 ...
 /**
  * Esta classe contém a aplicação principal que simula um sistema de venda de ingressos e filtragem de eventos.
  * Ela permite que o usuário escolha entre comprar ingressos ou aplicar filtros para buscar eventos específicos.
 ...
 public class App {
     ...
     public static void main(String[] args) {
         ...
         // Criação de um scanner para ler entradas do usuário.
         Scanner s = new Scanner(System.in);
 
         // Solicita ao usuário seu nome de usuário e e-mail.
         ...
         // Pergunta ao usuário se deseja testar a venda de ingressos ou filtro.
         String answ;
         System.out.println("Testar Venda de ingressos ou filtro? (v/f)");
         answ = s.nextLine();
         
         // Criação de locais e eventos para a simulação.
         ...
         // Criação de eventos do tipo Show, Festival, Esporte e Teatro, e adição ao histórico de eventos.
         ...
         // Se a escolha for "v", o usuário pode comprar ingressos para um evento.
         if (answ.equals("v")) {
         ...
         // Se a escolha for "f", o usuário pode aplicar filtros para buscar eventos.
